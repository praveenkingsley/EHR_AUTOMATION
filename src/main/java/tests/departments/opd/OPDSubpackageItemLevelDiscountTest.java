...
public class OPDSubpackageItemLevelDiscountTest extends TestBase {
    static Model_Patient myPatient;
    String patientKey = Cls_Generic_Methods.getConfigValues("patientKeyUsed");
    Page_NewPatientRegisteration oPage_NewPatientRegisteration;

    @Test(enabled = true, description = "add Patient In Opd")
    public void addPatientInOpd() {
    ...
    @Test(enabled = true, description = "create cash bill and validate the Subpackage item level  Discount In OPD")
    public void createCashBillAndValidateSubPackageItemLevelDiscountInOPD() {
        ...
        try {
            ...
            if (bPatientFound) {
                ...
                Cls_Generic_Methods.clickElement(oPage_Bills.button_clickOPDPlusActionButton);
                ...
                Cls_Generic_Methods.waitForElementToBeDisplayed(oPage_Bills.button_clickOPDPlusActionButton, 30);
                Cls_Generic_Methods.clickElement(oPage_Bills.button_clickOPDPlusActionButton);
                Cls_Generic_Methods.customWait(4);
                Cls_Generic_Methods.clickElementByJS(driver, oPage_Bills.button_newPackage);
                Cls_Generic_Methods.customWait(3);
    ...
    @Test(enabled = true, description = "create Draft bill and validate the Subpackage item level  Discount In OPD")
    public void createCreditBillAndValidateSubPackageItemLevelDiscountInOPD() {
        oPage_PatientAppointmentDetails = new Page_PatientAppointmentDetails(driver);
        Page_Bills oPage_Bills = new Page_Bills(driver);
        Page_IPD oPage_IPD = new Page_IPD(driver);
        Page_OPD oPage_OPD = new Page_OPD(driver);
        ...
        try {
            ...
            concatPatientFullName = concatPatientFullName.toUpperCase().trim();
            Cls_Generic_Methods.waitForElementToBeDisplayed(oPage_PatientAppointmentDetails.img_patientProfilePicOnPatientDetailsSection, 10);
            m_assert.assertTrue(CommonActions.selectTabOnDepartmentPage(oPage_OPD.tabs_appointmentTabsOnHomepage, OPD_Data.tab_MY_QUEUE), "Validate " + OPD_Data.tab_MY_QUEUE + " tab is selected");
            Cls_Generic_Methods.customWait(10);
            ...
            if (bPatientFound) {
                ...
                Cls_Generic_Methods.waitForElementToBeDisplayed(oPage_Bills.radioButton_creditBillType, 20);
                Cls_Generic_Methods.clickElement(oPage_Bills.radioButton_creditBillType);
                Cls_Generic_Methods.customWait(3);
                Cls_Generic_Methods.clickElement(oPage_Bills.button_clickOPDPlusActionButton);
                Cls_Generic_Methods.customWait(4);
                Cls_Generic_Methods.clickElementByJS(driver, oPage_Bills.button_newPackage);
                ...
                Cls_Generic_Methods.clickElement(oPage_Bills.select_package.get(0));
                Cls_Generic_Methods.customWait(3);
                m_assert.assertTrue(Cls_Generic_Methods.selectElementByVisibleText(oPage_Bills.select_packageName, sPackageName), "Selected package name = <b>" + sPackageName + "</b> ");
                Cls_Generic_Methods.customWait(4);
                String sQTY = Cls_Generic_Methods.getElementAttribute(oPage_Bills.input_Quantity.get(0), "value");
                String sUnitPrice = Cls_Generic_Methods.getElementAttribute(oPage_Bills.input_unitPrice.get(0), "value");
                String sGrossPrice = Cls_Generic_Methods.getElementAttribute(oPage_Bills.input_grossPrice.get(0), "value");
                ...
                double dTotalOfAllDiscountOnItemsAfterApplyingGD = Double.parseDouble(sTotalOfAllDiscountOnItemsAfterApplyingGD);
                m_assert.assertTrue((dTotalDiscountOnItemsAfterApplyingGD == dTotalOfAllDiscountOnItemsAfterApplyingGD), "Total discount and total of all discount fields, values matching on UI = <b>" + dTotalOfAllDiscountOnItemsAfterApplyingGD + "</b>");
                Cls_Generic_Methods.scrollToElementByAction(driver, oPage_IPD.button_removePaymentReceivedDetailsUnderBills);
                Cls_Generic_Methods.clickElement(oPage_IPD.button_removePaymentReceivedDetailsUnderBills);
                Cls_Generic_Methods.scrollToElementByAction(driver, oPage_Bills.input_amountPendingFieldInOPD);
                String sAmountPendingOnUI = Cls_Generic_Methods.getElementAttribute(oPage_Bills.input_amountPendingFieldInOPD, "value");
            ...
            Cls_Generic_Methods.customWait(3);
            m_assert.assertTrue(Cls_Generic_Methods.selectElementByVisibleText(oPage_Bills.select_secondPackageName, sSecondPackage), "Selected package name = <b>" + sSecondPackage + "</b> ");
            Cls_Generic_Methods.customWait(4);
            String sQTY1 = Cls_Generic_Methods.getElementAttribute(oPage_Bills.input_Quantity.get(1), "value");
            String sUnitPrice1 = Cls_Generic_Methods.getElementAttribute(oPage_Bills.input_unitPrice.get(1), "value");
            Cls_Generic_Methods.customWait();
    ...
    @Test(enabled = true, description = "create Credit bill and validate the Subpackage item level  Discount In OPD")
    public void createDraftBillAndValidateSubPackageItemLevelDiscountInOPD() {
        oPage_PatientAppointmentDetails = new Page_PatientAppointmentDetails(driver);
        Page_Bills oPage_Bills = new Page_Bills(driver);
        Page_IPD oPage_IPD = new Page_IPD(driver);
        Page_OPD oPage_OPD = new Page_OPD(driver);
        ...
        String sDiscountReason = "Reason" + getRandomUniqueString(6);
        String sSecondPackage = "SecondPack";
        String billOptionToSelect = "New Draft Bill";
        try {
            CommonActions.loginFunctionality(oEHR_Data.user_PRAkashTest);
            CommonActions.selectFacility("TST");
            CommonActions.selectDepartmentOnApp("OPD");
            ...
            if (bPatientFound) {
                ...
                Cls_Generic_Methods.clearValuesInElement(oPage_Bills.input_amountPendingFieldInOPD);
                m_assert.assertTrue(Cls_Generic_Methods.sendKeysIntoElement(oPage_Bills.input_amountPendingFieldInOPD, sAmountRemainingOnUI), "Pending amount entered =  <b> " + sAmountRemainingOnUI + "</b>");
    ...
    @Test(enabled = true, description = "create a bill and validate the Subpackage item level Discount by adding invoice sets In OPD")
    public void createCashBillAndValidateSubPackageItemLevelDiscountByAddingInvoiceSetsInOPD() {
        oPage_PatientAppointmentDetails = new Page_PatientAppointmentDetails(driver);
        Page_Bills oPage_Bills = new Page_Bills(driver);
        Page_IPD oPage_IPD = new Page_IPD(driver);
        Page_OPD oPage_OPD = new Page_OPD(driver);
        ...
        String sGlobalDiscount = "10";
        String sDiscountReason = "Reason" + getRandomUniqueString(6);
        String sInvoiceSetName = "AutomationDataOPD";
        String billOptionToSelect = "New Bill";
        try {
            CommonActions.loginFunctionality(oEHR_Data.user_PRAkashTest);
            CommonActions.selectDepartmentOnApp("OPD");
            ...
            if (bPatientFound) {
                ...
                // m_assert.assertTrue(Cls_Generic_Methods.clickElement(driver, oPage_Bills.button_applyGlobalDiscount), "Clicked on apply global discount button");
                try {
                    m_assert.assertTrue(Cls_Generic_Methods.clickElement(driver, oPage_Bills.button_applyGlobalDiscountForSecondPackageInOPD), "Clicked on apply global discount button");
                } catch (Exception e) {
                    Alert alert = driver.switchTo().alert();
                    String alertText = alert.getText();
                    System.out.println("Alert data: " + alertText);
    ...
    @Test(enabled = true, description = "create credit bill and validate the Subpackage item level Discount by adding invoice sets In OPD")
    public void createCreditBillForContactAndValidateSubPackageItemLevelDiscountInOPD() {
        oPage_PatientAppointmentDetails = new Page_PatientAppointmentDetails(driver);
        Page_Bills oPage_Bills = new Page_Bills(driver);
        Page_IPD oPage_IPD = new Page_IPD(driver);
        Page_OPD oPage_OPD = new Page_OPD(driver);
        boolean bPatientFound = false;
        String sPackageName = "AutomationContactPackage";
        String sDiscountAmountOnFirstSubPackageItem = "4";
        String sDiscountAmountOnSecondSubPackageItem = "3";
        String sGlobalDiscount = "10";
        String sDiscountReason = "Reason" + getRandomUniqueString(6);
        String sSecondPackageName = "AutomationContactPackage";
        String sContactGroup = "Insurance";
        String sPayer = "Aditya Birla Health Insurance Company Limited";
        String billOptionToSelect = "New Bill";
        ...
        try {
            ...
            if (bPatientFound) {
                ...
                Cls_Generic_Methods.clickElement(oPage_Bills.radioButton_creditBillType);
                Cls_Generic_Methods.customWait(3);
                Cls_Generic_Methods.clickElement(oPage_Bills.select_contactFiled);
                Cls_Generic_Methods.customWait();
                boolean bContactGroupFound = false;
                for (WebElement eContactGroup : oPage_Bills.list_contactGroup) {

                    if (Cls_Generic_Methods.getTextInElement(eContactGroup).equalsIgnoreCase(sContactGroup)) {
                        bContactGroupFound = true;
                        Cls_Generic_Methods.clickElement(eContactGroup);
                        break;
                    }
                }
                m_assert.assertTrue(true, "Contact group selected: <b> " + sContactGroup + " </b> ");
                // m_assert.assertTrue(Cls_Generic_Methods.selectElementByVisibleText(oPage_Bills.select_packageName,sContactGroup),"Selected Contact group = <b>" + sContactGroup + "</b> ");
                Cls_Generic_Methods.customWait(3);
                Cls_Generic_Methods.clickElement(oPage_Bills.select_payerField);
                Cls_Generic_Methods.customWait();
                boolean bPayerFoundInBills = false;
                for (WebElement ePayer : oPage_Bills.list_payerNames) {
                    if (Cls_Generic_Methods.getTextInElement(ePayer).equalsIgnoreCase(sPayer)) {
                        bPayerFoundInBills = true;
                        Cls_Generic_Methods.clickElement(ePayer);
                        break;
                    }
                }
                m_assert.assertTrue(true, "Payer selected: <b> " + sPayer + " </b> ");
                Cls_Generic_Methods.customWait(4);
                Cls_Generic_Methods.clickElement(oPage_Bills.button_clickOPDPlusActionButton);
                Cls_Generic_Methods.customWait(4);
                Cls_Generic_Methods.clickElementByJS(driver, oPage_Bills.button_newPackage);
...
//                html.sendKeys(Keys.chord(Keys.CONTROL, Keys.SUBTRACT));
                ...
                Cls_Generic_Methods.clickElement(oPage_Bills.button_clickOPDPlusActionButton);
                Cls_Generic_Methods.customWait(4);
                Cls_Generic_Methods.scrollToElementByJS(oPage_Bills.button_newPackage);
                Cls_Generic_Methods.customWait();
                Cls_Generic_Methods.clickElementByJS(driver, oPage_Bills.button_newPackage);
                Cls_Generic_Methods.customWait(3);
                Cls_Generic_Methods.scrollToElementByAction(driver, oPage_Bills.select_package.get(1));
//                Cls_Generic_Methods.clickElement(oPage_Bills.select_package.get(1));
                m_assert.assertTrue(Cls_Generic_Methods.selectElementByVisibleText(oPage_Bills.select_secondPackageName, sSecondPackageName), "Selected package name = <b>" + sSecondPackageName + "</b> ");
                // Cls_Generic_Methods.selectElementByVisibleText(oPage_Bills.option_invoiceSets, sInvoiceSetName);
                Cls_Generic_Methods.customWait(4);
                String sQTYForSecondPackage = Cls_Generic_Methods.getElementAttribute(oPage_Bills.input_Quantity.get(1), "value");
                String sUnitPriceForSecondPackage = Cls_Generic_Methods.getElementAttribute(oPage_Bills.input_unitPrice.get(1), "value");
                ...
                String sNetPriceForSecondPackage = Cls_Generic_Methods.getElementAttribute(oPage_Bills.input_netAmount.get(1), "value");
                double dOverAllNetPriceOnPackageForSecondPackage = Double.parseDouble(sNetPriceForSecondPackage);
                Cls_Generic_Methods.scrollToElementByAction(driver, oPage_Bills.input_itemWiseDiscountButton.get(1));
                Cls_Generic_Methods.clickElement(oPage_Bills.input_itemWiseDiscountButton.get(1));
                Cls_Generic_Methods.customWait(4);
                Cls_Generic_Methods.clickElement(driver, oPage_Bills.button_deleteItemLevelDiscount.get(1));
                if (Cls_Generic_Methods.isElementDisplayed(oPage_Bills.list_subpackageItemLevelDiscountField.get(2))) {
...
//                html1.sendKeys(Keys.chord(Keys.CONTROL, Keys.ADD));
                ...
                //bill preview validation
                String sFirstSubpackageItemDiscountOnBillPreview = Cls_Generic_Methods.getTextInElement(oPage_Bills.text_subPackageItemDiscountOnBillPreview.get(0));//0
                dFirstSubpackageItemDiscountOnBillPreview = Double.parseDouble(sFirstSubpackageItemDiscountOnBillPreview);
                String sSecondSubpackageItemDiscountOnBillPreview = Cls_Generic_Methods.getTextInElement(oPage_Bills.text_subPackageItemDiscountOnBillPreview.get(1));//1
                dSecondSubpackageItemDiscountOnBillPreview = Double.parseDouble(sSecondSubpackageItemDiscountOnBillPreview);
                m_assert.assertTrue((dFirstSubpackageItemDiscountOnBillPreview == dDiscountOnFirstItemAfterApplyingGlobalDiscountInPercentage && dSecondSubpackageItemDiscountOnBillPreview == dDiscountOnSecondItemAfterApplyingGlobalDiscountInPercentage), "Discount amount is matching with calculated subpackage item level discounts 1st item1 on preview : <b>" + dFirstSubpackageItemDiscountOnBillPreview + "</b> 2nd item discount on bill preview : <b>" + dSecondSubpackageItemDiscountOnBillPreview);
                String sOverDiscountAmountOnPackageOnPreview = Cls_Generic_Methods.getTextInElement(oPage_Bills.List_overAllPackageItemDiscountOnBillPreview.get(0));
                String sOverDiscountAmountOnPackageInPreview = sOverDiscountAmountOnPackageOnPreview.replaceAll("\\s", "");
                ...
                Cls_Generic_Methods.clickElement(driver, oPage_Bills.button_cancelBill);
                Cls_Generic_Methods.customWait(4);
                Cls_Generic_Methods.clickElementByJS(driver, oPage_Bills.button_confirmCancelCreditBill);
                Cls_Generic_Methods.customWait();
                Cls_Generic_Methods.clickElement(oPage_Bills.button_closeBill);
                Cls_Generic_Methods.customWait(3);
            }
    ...
    @Test(enabled = true, description = "create Template Bill And Validate SubPackage Item Level Discount In OPD")
    public void createTemplateBillAndValidateSubPackageItemLevelDiscountInOPD() {
        oPage_PatientAppointmentDetails = new Page_PatientAppointmentDetails(driver);
        ...
        String sGlobalDiscount = "10";
        String sDiscountReason = "Reason" + getRandomUniqueString(6);
        String sInvoiceSetName = "OPDRecieptTemplateAutomation";
        try {
            CommonActions.loginFunctionality(oEHR_Data.user_PRAkashTest);
            CommonActions.selectDepartmentOnApp("OPD");
            myPatient = map_PatientsInExcel.get(patientKey);
            ...
            if (bPatientFound) {
                ...
                m_assert.assertTrue(true, "Selected template bill =  <b>" + sInvoiceSetName + "</b> ");
                Cls_Generic_Methods.customWait(4);
                String sQTY = Cls_Generic_Methods.getElementAttribute(oPage_Bills.input_Quantity.get(0), "value");
                String sUnitPrice = Cls_Generic_Methods.getElementAttribute(oPage_Bills.input_unitPrice.get(0), "value");
                String sGrossPrice = Cls_Generic_Methods.getElementAttribute(oPage_Bills.input_grossPrice.get(0), "value");
                ...
                Cls_Generic_Methods.clearValuesInElement(oPage_Bills.input_amountPendingFieldInOPD);
                Cls_Generic_Methods.customWait();
                Cls_Generic_Methods.sendKeysIntoElement(oPage_Bills.input_amountPendingFieldInOPD, sAmountRemainingOnUI);
                Cls_Generic_Methods.customWait(2);

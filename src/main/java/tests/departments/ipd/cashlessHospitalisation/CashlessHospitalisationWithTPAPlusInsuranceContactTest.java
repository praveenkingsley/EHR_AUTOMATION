...
public class CashlessHospitalisationWithTPAPlusInsuranceContactTest extends TestBase {
    ...
    public void validateTpaPlusInsuranceDetailsForIpdPatient() {
        Page_IPD oPage_IPD = new Page_IPD(driver);
        ...
        String sContactGroup = "TPA+Insurance";
            ...
            try {
                ...
                if (bPatientNameFound) {
                    ...
                    if (sContactField.equals("Select Contact")) {
                        ...
                        if (Cls_Generic_Methods.isElementDisplayed(oPage_IPD.select_insurerFieldUnderInsuranceDetailsForm)) {
                            m_assert.assertFalse("Insurer field is displayed");
                        } else {
                            m_assert.assertTrue("Insurer field is not displayed");
                        }
                        Cls_Generic_Methods.customWait(5);
                    ...
                    Cls_Generic_Methods.customWait(3);
                    if (Cls_Generic_Methods.isElementDisplayed(oPage_IPD.select_insurerFieldUnderInsuranceDetailsForm)) {
                        Cls_Generic_Methods.selectElementByVisibleText(oPage_IPD.select_insurerFieldUnderInsuranceDetailsForm, mapTracker.get(key_CreatedAt_InsuranceDisplayName));
                        String sInsurerNameOnUI = Cls_Generic_Methods.getSelectedValue(oPage_IPD.select_insurerFieldUnderInsuranceDetailsForm);
                        m_assert.assertTrue("Selected insurer name = <b>" + sInsurerNameOnUI + "</b>");
                    } else {
                        m_assert.assertFalse("insurer field is not displayed");
                    }
                    ...
                    if (Cls_Generic_Methods.isElementDisplayed(oPage_IPD.text_insuranceDisplayNameUnderInsuranceDetailsInIpdRHS)) {
                        String sPayerDisplayName = Cls_Generic_Methods.getTextInElement(oPage_IPD.text_insuranceDisplayNameUnderInsuranceDetailsInIpdRHS);
                        if (sPayerDisplayName.equals(mapTracker.get(key_CreatedAt_TpaDisplayName))) {
                            m_assert.assertTrue("Expected TPA display name Displayed =  <b>" + sPayerDisplayName + "</b>");
                        } else {
                    ...
                    if (Cls_Generic_Methods.isElementDisplayed(oPage_IPD.text_insuranceNameUnderInsuranceDetailsInIpdRHS)) {
                        ...
                        if (sInsuranceName.equals(mapTracker.get(key_CreatedAt_InsurancePayerTypeMaster))) {
                            m_assert.assertTrue("Expected Insurance Name name Displayed =  <b>" + sInsuranceName + "</b>");
                        } else {
                            m_assert.assertFalse("Expected Insurance Name name is not displaying");
                        }
                    } else {
                        m_assert.assertFalse("Insurance Name name is not visible");
                    }
                    ...
                    if (Cls_Generic_Methods.isElementDisplayed(oPage_IPD.text_patientPayerDataFieldNameInsuranceDetailsInIpdRHSForTPAPlusInsurancePayer)) {
                        String sPatientPayerDataFieldNameOnUI = Cls_Generic_Methods.getTextInElement(oPage_IPD.text_patientPayerDataFieldNameInsuranceDetailsInIpdRHSForTPAPlusInsurancePayer);
                        ...
                        if (Cls_Generic_Methods.isElementDisplayed(oPage_IPD.text_patientPayerDataInputFieldForTpaPlusInsuranceContactUnderInsuranceDetailsInIpdRHS)) {
                            String sPatientPayerDataInputInfo = Cls_Generic_Methods.getTextInElement(oPage_IPD.text_patientPayerDataInputFieldForTpaPlusInsuranceContactUnderInsuranceDetailsInIpdRHS);
    ...
    @Test(enabled = true, description = "Validate TPA+ Insurance Details In Draft Bill")
    public void ValidateTpaPlusInsuranceDetailsInDraftBill() throws Exception {
        Page_IPD oPage_IPD = new Page_IPD(driver);
        myPatient = map_PatientsInExcel.get(patientKey);
        oEHR_Data = new EHR_Data();
        String patientName = null;
        ...
        try {
            ...
            try {
                ...
                if (bPatientNameFound) {
                    ...
                    try {
                        String sInsurerNameUnderBills = Cls_Generic_Methods.getTextInElement(oPage_IPD.input_insurerFieldInBill);
                        if (sInsurerNameUnderBills.equals(mapTracker.get(key_CreatedAt_InsuranceDisplayName))) {
                            m_assert.assertTrue("Expected Insurer name found under bills = <b> " + sInsurerNameUnderBills + "</b>");
                        } else {
                            m_assert.assertWarn("Issue: Expected Insurer name is not Found");
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                        m_assert.assertFatal("Exception while getting the text from insurer field in draft bill" + e);
                    }
                    try {
    ...
    @Test(enabled = true, description = "Validate TPA+Insurance Details In Pharmacy Store")
    public void validatingTpaPlusInsuranceContactDetailsInPharmacyStore() {
        ...
        try {
            ...
            try {
                ...
                String sTpaFieldUnderSales = Cls_Generic_Methods.getElementAttribute(oPage_Sale.input_tpaNameFieldUnderSalesOrder, "value");
                if (sTpaFieldUnderSales.equals(mapTracker.get(key_CreatedAt_TpaPayerTypeMaster))) {
                    m_assert.assertTrue("Expected Tpa name present in sales order form <b>" + sTpaFieldUnderSales + "</b>");
                } else {
                ...
                if (sCorporateUnderSales.equals(mapTracker.get(key_CreatedAt_CorporateName))) {
                ...
                String sInsurerUnderSales = Cls_Generic_Methods.getTextInElement(oPage_Sale.input_insurerFieldUnderSalesOrder);
                if (sInsurerUnderSales.equals(mapTracker.get(key_CreatedAt_InsuranceDisplayName))) {
                    m_assert.assertTrue("Expected Insurer name present in sales order form <b>" + sInsurerUnderSales + "</b>");
                } else {
                    m_assert.assertWarn("Expected Insurer name is not displaying");
                }
                ...
                m_assert.assertInfo(Cls_Generic_Methods.clickElement(oPage_SalesOrder.button_saveChangesOnSalesOrder), "Clicked on save sales order");
                Cls_Generic_Methods.customWait(10);

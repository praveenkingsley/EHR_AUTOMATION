package tests.settings.facilitySetting.financial;
...
public class SurgeryPackageTest extends TestBase {
	...
	public void createPatientToValidateSurgeryPackage() {
	...
	public void validateAddSurgeryPackageItem() {
		// add new item in surgery package item, go to add new Surgery package,
		// select facility >> click on add service breakup >> created item should be displayed under list

	}

	@Test(enabled = true, description = "Desc")
	public void validateAddNewSurgeryPackage() {
      //create new surgery package >> go to facility link >> search for created package and activate the same
		// go to opd/ipd >>click on bills >> new bill >> click add new package >> validate newly created package


	}

	@Test(enabled = true, description = "Desc")
	public void validateEditAndDisableSurgeryPackages() {
		// validate edit and disable functionality (validate by getting the count of active and inactive package)
		// for the created package

	}

	@Test(enabled = true, description = "Desc")
	public void removePatientCreatedForValidateSurgeryPackage() {

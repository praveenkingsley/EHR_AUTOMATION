...
public class AllBillsPolicyTest extends IPD_Policy {
    ...
    String sViewAllBillsPolicyComponent = "VIEW (ALL BILLS)";

    @Test(description = "Validate IPD/OT Billing Amount Details View access")
    public void validatePolicy_viewAllBills() {
        ...
        try {
            ...
            setPolicy(sViewAllBillsPolicyComponent, false);
            ...
            createNewBill();
            boolean allBillsDisplayed = Cls_Generic_Methods.waitForElementToBeDisplayed(oPage_IPD.text_billsAmount, 6);
            m_assert.assertFalse(allBillsDisplayed, "<font color='blue'>Validated " + sPolicyDescription + " is disabled for the user</font>");

            switchToAdmin();
            setPolicy(sViewAllBillsPolicyComponent, true);
            ...
            allBillsDisplayed = Cls_Generic_Methods.waitForElementToBeDisplayed(oPage_IPD.text_billsAmount, 6);
            m_assert.assertTrue(allBillsDisplayed, "<font color='blue'>Validated " + sPolicyDescription + " is enabled for the user</font>");

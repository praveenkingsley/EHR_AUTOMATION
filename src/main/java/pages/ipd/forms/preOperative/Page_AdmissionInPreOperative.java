...
public class Page_AdmissionInPreOperative extends TestBase {
    ...
    @FindBy(xpath = "//b[text()='Pre-Operative']/following::div//a[contains(text(),'Admission')]")
    ...
    public WebElement button_filledIconInAdmissionInPreOperative;
    ...
    @FindBy(xpath = "//b[text()='Adm Date:']/parent::div")
    public WebElement text_admDateOnForm;
